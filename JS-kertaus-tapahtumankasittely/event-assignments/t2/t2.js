...
function displayRestaurants() {
  ...
  sortedRestaurants.forEach((restaurant, index) => {
    ...
    row.addEventListener('click', () => handleRestaurantClick(row, index));
  });
}

// Handle restaurant click
function handleRestaurantClick(clickedRow, index) {
  ...
  // Show modal with restaurant details
  showRestaurantDetails(sortedRestaurants[index]);
}
